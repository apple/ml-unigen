...
#
# Modified from https://github.com/showlab/Show-o/blob/main/models/modeling_utils.py
# Copyright 2024 The HuggingFace Inc. team, NUS Show Lab.
...
from diffusers.utils import (
    ...
    _add_variant, _get_checkpoint_shard_files, _get_model_file,
    deprecate, is_accelerate_available, is_torch_version, logging,
)
...
from diffusers.models.model_loading_utils import (
    _determine_device_map, _fetch_index_file, _load_state_dict_into_model,
    load_model_dict_into_meta, load_state_dict,
)
...
def _find_index_file(pretrained_model_name_or_path: str) -> str:
    """
    Tries to find either diffusion_pytorch_model.bin.index.json or pytorch_model.bin.index.json
    """
    candidates = [
        "pytorch_model.bin.index.json",
    ]
    for name in candidates:
        index_path = Path(pretrained_model_name_or_path) / name
...
class ModelMixin(torch.nn.Module, PushToHubMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        if index_file is None or not index_file.is_file():
            index_file = _find_index_file(pretrained_model_name_or_path)
